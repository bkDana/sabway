...
public class CustomerController {
   ...
   public ModelAndView allCustomerList(@RequestParam String keyword) {
	...
	// 회원 키워드검색
	@RequestMapping(value = "/customerKeyword.do", produces = "application/json; charset=utf-8")
	public String customerKeyword(@RequestParam String keyword) {
		System.out.println(keyword);
		ArrayList<Customer> searchKeyword = (ArrayList<Customer>) customerService.customerKeyword(keyword);
