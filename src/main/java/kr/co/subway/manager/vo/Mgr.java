...
public class Mgr {
	...
	public String getMgrAddrType() {
		return mgrAddrType;
	}
	public void setMgrAddrType(String mgrAddrType) {
		this.mgrAddrType = mgrAddrType;
	}
