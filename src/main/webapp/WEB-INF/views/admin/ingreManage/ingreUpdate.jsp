...
<section id="content-wrapper" class="clearfix">
	...
	<div class="area">
		...
		<form action="/ingreUpdate.do" method="post">
				<table class="comm-tbl">
					...
					<tr>
						<th>상품명</th>
						<td>
							<input type="text" name="ingreLabel" id="ingreLabel" value="${iv.ingreLabel}">
						</td>
					</tr>
					<tr>
						<th>판매가격</th>
						<td>
							15cm : <input type="text" name="ingreCost15" id="ingreCost15" class="short" value="${iv.ingreCost15 }"> 원 &nbsp;&nbsp;
							30cm : <input type="text" name="ingreCost30" id="ingreCost30" class="short" value="${iv.ingreCost30 }"> 원
						</td>
					</tr>
					<tr>
						<th>활성화/비활성화</th>
					...
					<tr>
						<th>칼로리</th>
						<td>
							<input type="text" name="ingreKcal" class="short" value="${iv.ingreKcal}"> Kcal
						</td>
					</tr>
					<tr>
						<th>이미지 등록</th>
