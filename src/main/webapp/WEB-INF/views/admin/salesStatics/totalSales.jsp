...
<section id="content-wrapper" class="clearfix">
	...
	<div class="area">
		...
		<div id="container" style="width: 700px; height: 400px; margin: 0 auto"></div> <Br>
    	<div id="container2" style="width: 700px; height: 400px; margin: 0 auto"></div> <br>
    	<div id="container3" style="width: 700px; height: 400px; margin: 0 auto"></div> 
	
	<form action="/salesStatics/getSales.do">
		<button type="button" id="btn1">테스트1</button>
	</form>
	<div id="test1" style="width: 700px; height: 400px; margin: 0 auto"></div><br>
